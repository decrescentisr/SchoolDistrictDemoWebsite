<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewstudent.aspx.cs" Inherits="SchoolDistWeb.viewstudent" %>
...
<body>
    ...
    <div class="hero-image" >
        <img src="images/viewstudent.jpeg" class="responsive" style="opacity: .80"/>
        <div class="hero-text">
            <h1 style="font-size:50px; color: black;">Student Search</h1>            
        </div>
    </div>
