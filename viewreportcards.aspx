<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewreportcards.aspx.cs" Inherits="SchoolDistWeb.viewreportcards" %>
...
<body>
    ...
    <div class="hero-image" >
        <img src="images/grades.jpg" class="responsive" style="opacity: .80"/>
        <div class="hero-text">
            <h1 style="font-size:50px; color: black;">Report Card Search</h1>            
        </div>
        
    </div>
    <br />
    <center><img src="images/reportcards.png"/></center>
     <h2 style="text-align:center; font-size: 30px; color: black;">Please search for your child&#39;s report card below. Click on the download link to save a copy. Please contact your student&#39;s teacher if you are unable to locate your child&#39;s report card.</h2>

    <form id="form1" runat="server">
         
        <br />
        <asp:Label ID="lblFirst" runat="server" Text="Enter Student's First Name:"></asp:Label>
        <br />
        ...
        <br />
        <asp:Label ID="lblLast" runat="server" Text="Enter Student's Last Name:"></asp:Label>
        <br />
        <asp:TextBox ID="txtLast" runat="server" ></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLast" ErrorMessage="This Field is Required" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
        ...
        <asp:GridView ID="grdCards" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
