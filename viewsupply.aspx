<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewsupply.aspx.cs" Inherits="SchoolDistWeb.viewsupply" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>View School Supply Lists</title>
...
<body>
    ...
    <div class="w3-top">
     ...
     <div class="hero-image" >
        <img src="images/schoolsupply.jpeg" class="responsive" style="opacity: .80"/>
        <div class="hero-text">
            <h1 style="font-size:50px; color: black;">School Supply List Search</h1>            
        </div>
    </div>
    ...
    <form id="form1" runat="server">
         <h2 style="text-align: center; font-size: 30px;">Search for your child's teacher below to view their school supply list. If you have any questions, please reach out to your teacher or principal.</h2>
        <br />
        
        <asp:Label ID="lblLast" runat="server" Text="Enter Teacher's Last Name:"></asp:Label>
        <br />
        <asp:TextBox ID="txtLastName" runat="server" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtLastName" ErrorMessage="This Field is Required" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
        <asp:Button ID="btnSearch" runat="server" Text="Search" class="btn btn-primary" OnClick="btnSearch_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnPrints" runat="server" Text="Print" class="btn btn-primary" OnClick="btnPrints_Click" />
        <br />
        <br />
        <asp:Label ID="lblMessage" runat="server" ForeColor="Red" Visible="False" Text="You Successfully Searched for Supplies!...This page will redirect to the portal in 180 seconds..."></asp:Label>

        <br />

        <br />

        <asp:GridView ID="grdSupply" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
...
<AlternatingRowStyle BackColor="White" ForeColor="#000000"></AlternatingRowStyle>
            <Columns>
                ...
                <asp:BoundField DataField="Supply1" HeaderText="Supply1" />
                <asp:BoundField DataField="Supply2" HeaderText="Supply2" />
                <asp:BoundField DataField="Supply3" HeaderText="Supply3" />
                <asp:BoundField DataField="Supply4" HeaderText="Supply4" />
                <asp:BoundField DataField="Supply5" HeaderText="Supply5" />
                <asp:BoundField DataField="Supply6" HeaderText="Supply6" />
                <asp:BoundField DataField="Supply7" HeaderText="Supply7" />
                <asp:BoundField DataField="Supply8" HeaderText="Supply8" />
...
<RowStyle BackColor="#A1DCF2"></RowStyle>
    ...
    <footer>
     ...
     <script>
        //Opens print window to print gridview
        function printing() {
            window.print();
        }
